...
#
# $$
# \mathbf{D}_\text{h} = \phi \left( D_D \mathbf{I} + \beta_T \|\mathbf{v}\| \mathbf{I} + (\beta_\text{L} - \beta_T) \frac{\mathbf{v} \otimes \mathbf{v}}{\|\mathbf{v}\|} \right)
# $$
#
...
fracture_stats = generate_random_fracture_stats(
    ...
    mean_dist="constant",  # constant, uniform, gaussian, or truncated
)
...
user_parameters = {
    ...
    "inlet_pressure_expression": "1000*9.81*(500-z)+294300",
